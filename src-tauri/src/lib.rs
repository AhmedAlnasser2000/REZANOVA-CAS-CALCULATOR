...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            notebook_storage::notebook_begin_asset_upload,
            ...
            notebook_storage::notebook_list_versions,
            notebook_storage::notebook_save_version,
            notebook_storage::notebook_move_record_to_trash,
            notebook_storage::notebook_list_trash,
            notebook_storage::notebook_restore_record_from_trash,
            notebook_storage::notebook_delete_record_permanently,

...
const BUILTIN_HOST_DEFINITIONS: &[OoeBuiltinHostDefinition] = &[
    ...
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::StaleDrop,
        default_result_stability: OoeResultStability::Draft,
        description: "Main-thread TypeScript fallback host for Calculate quickform work.",
    },
    OoeBuiltinHostDefinition {
        ...
        default_result_stability: OoeResultStability::Draft,
        description: "Isolated Web Worker host for active Calculate quickform work.",
    },
    OoeBuiltinHostDefinition {
    ...
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::HardStop,
        default_result_stability: OoeResultStability::Draft,
        description: "Isolated Web Worker host for active Geometry evaluation.",
    },
    OoeBuiltinHostDefinition {
        host_id: "graph-sampling-runtime",
        host_kind: OoeHostKind::MainThreadTypeScript,
        thread_safety: OoeThreadSafety::MainThreadOnly,
        supported_task_classes: EXPLICIT_ONLY,
        budget_policy: OoeHostBudgetPolicy::Cooperative,
        cancellation_policy: OoeCancellationPolicy::Cooperative,
        default_result_stability: OoeResultStability::Draft,
        description: "Bounded cooperative fallback host for active Graph sampling.",
    },
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::HardStop,
        default_result_stability: OoeResultStability::Draft,
        description: "Single application-level isolated Web Worker host for active Graph sampling.",
    },
    OoeBuiltinHostDefinition {
        host_id: "graph-analysis-runtime",
        host_kind: OoeHostKind::MainThreadTypeScript,
        thread_safety: OoeThreadSafety::MainThreadOnly,
        supported_task_classes: EXPLICIT_ONLY,
        budget_policy: OoeHostBudgetPolicy::Cooperative,
        cancellation_policy: OoeCancellationPolicy::Cooperative,
        default_result_stability: OoeResultStability::Draft,
        description: "Bounded cooperative fallback host for selected-item Graph analysis.",
    },
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::HardStop,
        default_result_stability: OoeResultStability::Draft,
        description: "Independent isolated Web Worker host for selected-item Graph analysis.",
    },
    OoeBuiltinHostDefinition {
        host_id: "matrix-runtime",
        host_kind: OoeHostKind::MainThreadTypeScript,
        thread_safety: OoeThreadSafety::MainThreadOnly,
        supported_task_classes: EXPLICIT_ONLY,
        budget_policy: OoeHostBudgetPolicy::Unbudgeted,
        cancellation_policy: OoeCancellationPolicy::StaleDrop,
        default_result_stability: OoeResultStability::Draft,
        description: "Current main-thread TypeScript fallback host for Matrix provenance.",
    },
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::HardStop,
        default_result_stability: OoeResultStability::Draft,
        description: "Isolated Web Worker host for active Matrix operations.",
    },
    OoeBuiltinHostDefinition {
        host_id: "vector-runtime",
        host_kind: OoeHostKind::MainThreadTypeScript,
        thread_safety: OoeThreadSafety::MainThreadOnly,
        supported_task_classes: EXPLICIT_ONLY,
        budget_policy: OoeHostBudgetPolicy::Unbudgeted,
        cancellation_policy: OoeCancellationPolicy::StaleDrop,
        default_result_stability: OoeResultStability::Draft,
        description: "Current main-thread TypeScript fallback host for Vector provenance.",
    },
    OoeBuiltinHostDefinition {
        ...
        cancellation_policy: OoeCancellationPolicy::HardStop,
        default_result_stability: OoeResultStability::Draft,
        description: "Isolated Web Worker host for active Vector operations.",
    },
];
    ...
    fn registers_exact_current_active_host_ids() {
        ...
        assert_eq!(
            ...
            BTreeSet::from([
                ...
                "graph-analysis-runtime".to_string(),
                "graph-analysis-worker-runtime".to_string(),
                "graph-sampling-runtime".to_string(),
                "graph-sampling-worker-runtime".to_string(),

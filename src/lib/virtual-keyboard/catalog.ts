...
export const KEYBOARD_PAGE_SPECS: KeyboardPageSpec[] = [
  {
    ...
    modeVisibility: ['calculate', 'equation', 'matrix', 'vector', 'table', 'calculus', 'trigonometry', 'geometry'],
    rows: [
      [
  ...
  },
  {
    ...
    label: 'Algebra',
    capability: ALGEBRA,
    modeVisibility: ['calculate', 'equation', 'table', 'calculus'],
    rows: [
      [
  ...
  },
  {
    ...
    label: 'Relations',
    capability: ALGEBRA,
    modeVisibility: ['calculate', 'equation', 'calculus'],
    rows: [
      [
    ...
    rows: [
      ...
      [
        insertTemplateKey(
          'lin-parallel',
          'parallel',
          '\\operatorname{parallel}\\left(#0,#?\\right)',
          LINEAR,
          'matrixVec',
          'insert',
          {
            duplicateGroup: 'linear-parallel',
            lessonRef: 'milestone-04-linear-algebra-core',
            modeVisibility: ['vector'],
          },
        ),
        insertTemplateKey(
          'lin-distance',
          'distance',
          '\\operatorname{distance}\\left(#0,#?\\right)',
          LINEAR,
          'matrixVec',
          'insert',
          {
            duplicateGroup: 'linear-distance',
            lessonRef: 'milestone-04-linear-algebra-core',
            modeVisibility: ['vector'],
          },
        ),
        insertTemplateKey(
          'lin-parallelogram-area',
          'area',
          '\\operatorname{parallelogramArea}\\left(#0,#?\\right)',
          LINEAR,
          'matrixVec',
          'insert',
          {
            duplicateGroup: 'linear-parallelogram-area',
            lessonRef: 'milestone-04-linear-algebra-core',
            modeVisibility: ['vector'],
          },
        ),
        insertTemplateKey(
          'lin-triangle-area',
          'triArea',
          '\\operatorname{triangleArea}\\left(#0,#?\\right)',
          LINEAR,
          'matrixVec',
          'insert',
          {
            duplicateGroup: 'linear-triangle-area',
            lessonRef: 'milestone-04-linear-algebra-core',
            modeVisibility: ['vector'],
          },
        ),
        insertTemplateKey(
          'lin-volume',
          'volume',
          '\\operatorname{volume}\\left(#0,#?,#?\\right)',
          LINEAR,
          'matrixVec',
          'insert',
          {
            duplicateGroup: 'linear-volume',
            lessonRef: 'milestone-04-linear-algebra-core',
            modeVisibility: ['vector'],
          },
        ),

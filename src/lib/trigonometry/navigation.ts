...
const ROUTE_META: Record<TrigScreen, TrigRouteMeta> = {
  ...
  equationSolve: {
    ...
    description: 'Solve bounded equations such as sin(x)=1/2 or sin(2x)=0 through the shared trig editor.',
    helpText: 'Enter a supported equation in x in the top editor, then press EXE or F1.',
    guideArticleId: 'trig-equations',
    focusTarget: 'editor',
    editorMode: 'editable',
  },

...
const ROUTE_META: Record<EquationScreen, EquationRouteMeta> = {
  ...
  simultaneousMenu: {
    ...
    description: 'Choose a linear or polynomial system.',
    breadcrumb: ['Equation', 'Simultaneous'],
    helpText: 'Choose 2x2, 3x3, or Polynomial 2x2. F5 or Esc goes back.',
    selectionHint: '1-3: Open | ◂/▸: Move | EXE/F1: Select | F5/Esc: Back',
    focusTarget: 'menu',
  },
  linear2: {
  ...
  polynomialSystem2: {
    ...
    label: 'Polynomial 2x2 System',
    shortLabel: 'Polynomial 2x2',
    description: 'Solve two polynomial equations in x and y.',
    breadcrumb: ['Equation', 'Simultaneous', 'Polynomial 2x2'],
    badge: 'Polynomial 2x2',
    helpText: 'Enter two polynomial equations in x and y, then press EXE or F1 to solve.',
    focusTarget: 'simultaneous',
  },
};

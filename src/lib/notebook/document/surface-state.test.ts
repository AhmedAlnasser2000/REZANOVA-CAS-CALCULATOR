...
describe('Notebook rich surface state', () => {
  ...
  it('migrates version-4 documents continuously to version 9', () => {
    ...
    expect(migrated.document).toEqual({ ...version4, version: 9 });
  });
  ...
  it('migrates version-5 documents through the structured-block normalizer', () => {
    ...
    expect(migrated.document).toEqual({ ...version5, version: 9 });
  });

...
import {
  ...
  LINEAR_ALGEBRA_EXACT_MATRIX_POWER_ABS_LIMIT,
} from './dimension-contract';

const MAX_EXACT_EXPRESSION_DIMENSION = LINEAR_ALGEBRA_EXACT_EXPRESSION_MAX_DIMENSION;
const MAX_EXACT_EXPRESSION_POWER_ABS = LINEAR_ALGEBRA_EXACT_MATRIX_POWER_ABS_LIMIT;

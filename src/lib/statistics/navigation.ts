...
const ROUTE_META: Record<StatisticsScreen, StatisticsRouteMeta> = {
  home: {
    ...
    description: 'Choose a guided workflow or switch to Expression for a direct Statistics request.',
    helpText: 'Use EXE/F1 or keys 1-7 to open a statistics tool. Switch to Expression when you want to run a draft directly.',
  ...
  dataEntry: {
    ...
    helpText: 'Paste comma-separated or line-separated numeric values, then press EXE or F1. Switch to Expression to edit the Statistics request directly.',
    guideArticleId: 'statistics-descriptive',
  ...
  descriptive: {
    ...
    helpText: 'Choose the active source, update the guided inputs if needed, then press EXE or F1. Switch to Expression to edit the Statistics request directly.',
    guideArticleId: 'statistics-descriptive',
    focusTarget: 'guidedForm',
    editorMode: 'editable',
  },
  frequency: {
    ...
    helpText: 'Use the dataset/table actions, then press EXE or F1. Switch to Expression to edit the Statistics request directly.',
    guideArticleId: 'statistics-descriptive',
    focusTarget: 'guidedForm',
    editorMode: 'editable',
  },
  probabilityHome: {
    ...
    description: 'Choose a bounded distribution workflow, or switch to Expression for a structured probability request.',
    helpText: 'Use EXE/F1 or keys 1-3 to open a probability tool. Switch to Expression when you want to run a draft directly.',
  ...
  inferenceHome: {
    ...
    description: 'Choose a bounded inferential workflow, or switch to Expression for a structured inference request.',
    helpText: 'Use EXE/F1 or key 1 to open the mean inference tool. Switch to Expression when you want to run a structured draft directly.',
  ...
  binomial: {
    ...
    description: 'Evaluate bounded Binomial events from trials, success probability, and event values.',
    helpText: 'Choose a Binomial event and enter its parameters, then press EXE or F1. Switch to Expression to edit the request directly.',
    guideArticleId: 'statistics-probability',
    focusTarget: 'guidedForm',
    editorMode: 'editable',
  },
  normal: {
    ...
    description: 'Evaluate bounded Normal events or point density from a mean and standard deviation.',
    helpText: 'Choose a Normal event and enter its parameters, then press EXE or F1. Switch to Expression to edit the request directly.',
    guideArticleId: 'statistics-probability',
    focusTarget: 'guidedForm',
    editorMode: 'editable',
  },
  poisson: {
    ...
    description: 'Evaluate bounded Poisson events from a rate and event values.',
    helpText: 'Choose a Poisson event and enter its parameters, then press EXE or F1. Switch to Expression to edit the request directly.',
    guideArticleId: 'statistics-probability',
    focusTarget: 'guidedForm',
    editorMode: 'editable',
  },
  ...
  regression: {
    ...
    helpText: 'Enter at least two points, then press EXE or F1. Switch to Expression to edit the request directly.',

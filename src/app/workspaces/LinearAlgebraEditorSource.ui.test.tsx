...
describe('Linear algebra editor source', () => {
  it('uses the main editor for Matrix and Vector without secondary notation pads', async () => {
    ...
    expect(screen.getByLabelText('Active Matrix left operand')).toHaveValue('matrix-a');
    expect(screen.getByLabelText('Active Matrix right operand')).toHaveValue('matrix-b');
    ...
    expect(screen.getByLabelText('Active Vector first operand')).toHaveValue('vector-u');
    expect(screen.getByLabelText('Active Vector second operand')).toHaveValue('vector-v');

...
import type { GraphWorkspaceSessionStateV3 } from '../graphing/graph-workspace-session';
...
type ActiveSurfaceHostProps = {
  ...
  onUpdateGraphSurfaceState: (instanceId: string, state: GraphWorkspaceSessionStateV3) => void;

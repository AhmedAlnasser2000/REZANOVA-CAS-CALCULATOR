...
import type { GraphWorkspaceSessionStateV6 } from '../graphing/graph-workspace-session';
...
type ActiveSurfaceHostProps = {
  ...
  onUpdateGraphSurfaceState: (instanceId: string, state: GraphWorkspaceSessionStateV6) => void;

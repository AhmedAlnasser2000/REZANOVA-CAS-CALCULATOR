...
Program sequence and acceptance details live in `.memory/research/roadmaps/anti-regression-nine-move-roadmap.md`. The canary suite and native nine-workspace runtime-probe registry are verified; the next Incident Closure move is CI gate alignment.

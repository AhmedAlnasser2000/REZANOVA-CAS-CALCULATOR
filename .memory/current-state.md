...
Program sequence and acceptance details live in `.memory/research/roadmaps/anti-regression-nine-move-roadmap.md`. The canary suite, native nine-workspace runtime-probe registry, and CI gate alignment are verified; the next Incident Closure move is the seam-impact selector.

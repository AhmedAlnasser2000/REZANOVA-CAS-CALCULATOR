...
- Git posture: `main` is two approved local commits ahead of `origin/main`: `db674b13` (`PRINTER-DETAIL-CLIPBOARD-ROADMAP0`) and `f4cb2de2` (`PRINTER-SERIALIZATION-CONTRACT1`). No push is authorized; untracked `test-results/` remains unrelated and excluded.

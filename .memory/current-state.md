...
Program sequence and acceptance details live in `.memory/research/roadmaps/anti-regression-nine-move-roadmap.md`. The canary suite is verified; the next Incident Closure move is the native nine-workspace runtime-probe registry.

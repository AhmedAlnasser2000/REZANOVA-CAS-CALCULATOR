...
Program sequence and acceptance details live in `.memory/research/roadmaps/anti-regression-nine-move-roadmap.md`. All four Incident Closure moves and the mandatory nine-workspace verification sweep are complete; user acceptance of the review is pending, and Behavioral Ratchets remain blocked until that checkpoint is accepted.

...
Program sequence and acceptance details live in `.memory/research/roadmaps/anti-regression-nine-move-roadmap.md`. All four Incident Closure moves, the mandatory review, the Linear Algebra transition, and Behavioral Ratchets 5-8 are committed. Behavioral Ratchet 9 and the complete manual closeout are implemented and verified under standing commit approval; no push is authorized. Printer Core, detail-segment, and canonical clipboard planning remains paused for user acceptance of this closeout.

# COMPARTMENTS-DIAGNOSTICS-FILTER1 Commit Log
...
- `COMPARTMENTS-DIAGNOSTICS-FILTER1`
...
- `.memory/sessions/2026-06/2026-06-14/2026-06-14__compartments-diagnostics-filter1/*`

## Summary

The commit adds an event-only compartment filter to the developer OOE diagnostics panel.

# TRANSCENDENTAL-RISCH-EXP-QUADRATIC-PROOF1 Verification Summary
...
- The proof slice is isolated to the transcendental certificate proof module and focused tests.
- The proof object is internal/test-facing and is not called by integration dispatch.

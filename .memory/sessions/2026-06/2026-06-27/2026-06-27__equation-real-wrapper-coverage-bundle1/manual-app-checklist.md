...
`EQUATION-REAL-WRAPPER-COVERAGE-BUNDLE1` is planned but not implemented in this handoff. The manual checks below are for the future implementation session.
...
- Rational carrier wrappers either solve through existing top-level rational formula normalization or through a shared generated formula route without duplicating clearing logic.

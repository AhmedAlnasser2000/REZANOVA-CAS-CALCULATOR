...
- Status: verified
- Scope:
  - added `src/lib/algebra/polynomial-core.ts` as the shared exact one-variable polynomial substrate
  ...
  - added focused unit coverage in `src/lib/algebra/polynomial-core.test.ts` plus regression checks for patterns, factoring, guarded solve, and equation mode
- Behavioral note:

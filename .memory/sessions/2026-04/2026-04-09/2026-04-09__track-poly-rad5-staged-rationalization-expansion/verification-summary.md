...
## Commands
- `npx vitest run src/lib/symbolic-engine/radical.test.ts src/lib/algebra/algebra-transform.test.ts src/lib/engine/math-engine.test.ts src/lib/modes/calculate.test.ts src/lib/equation/shared-solve.test.ts src/lib/modes/equation.test.ts`

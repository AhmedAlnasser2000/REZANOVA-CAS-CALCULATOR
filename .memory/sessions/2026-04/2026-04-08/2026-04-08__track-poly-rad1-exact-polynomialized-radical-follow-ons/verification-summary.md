...
- Focused checks:
  - `npm run test:unit -- src/lib/algebra/polynomial-factor-solve.test.ts src/lib/engine/math-engine.test.ts src/lib/equation/shared-solve.test.ts src/AppMain.ui.test.tsx`

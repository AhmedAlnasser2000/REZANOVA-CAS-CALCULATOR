...
- `npm run test:unit -- src/components/MathEditor.test.ts src/lib/input/input-canonicalization.test.ts src/lib/calculus/derivative-request.test.ts src/lib/calculus/derivative-operator.test.ts` passed.

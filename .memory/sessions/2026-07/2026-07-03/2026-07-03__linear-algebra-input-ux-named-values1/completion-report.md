...
- 2026-07-03: Completed `LINEAR-ALGEBRA-NAMED-REPLAY-HISTORY1` as a backend gate; Matrix and Vector history, replay, OOE snapshots, and persisted seeds now carry launch-time named-value snapshots for stable replay after live library changes.

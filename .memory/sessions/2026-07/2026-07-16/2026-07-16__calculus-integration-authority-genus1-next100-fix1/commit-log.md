...
- `ALGEBRAIC-GENUS1-SECOND-KIND-LIVE1` - verified and approved for path-scoped commit; hash will be recorded in the next checkpoint because a commit cannot contain its own final hash.
- Three later approved commits remain pending.

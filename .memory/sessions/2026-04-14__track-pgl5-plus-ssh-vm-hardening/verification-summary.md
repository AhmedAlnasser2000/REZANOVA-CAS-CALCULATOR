...
- live `calcwiz-box` success and deliberate failure-path probes
...
## Manual Checks
- Live `calcwiz-box` success path completed with manifest `status: completed`.
- Live `calcwiz-box` success path completed with parity `resultClass: match`.

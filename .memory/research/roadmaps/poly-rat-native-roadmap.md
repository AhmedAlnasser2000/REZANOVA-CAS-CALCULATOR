...
- bivariate elimination is blocked on `.memory/research/roadmaps/multivariable-variable-policy-roadmap.md` and the first selected-target parameterized-solving slices in `.memory/research/roadmaps/equation-parameterized-solving-roadmap.md`

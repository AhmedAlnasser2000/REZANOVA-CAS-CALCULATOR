...
| Symbolic integration | `ready-with-adapter` | Bounded symbolic families now include derivative-backed distinct-linear partial fractions; broad rational/Risch-style integration remains deferred. |

...
- `supercarrier/compartment-state-surface-audit.md`: audit map for a future read-only compartment health/state projection over OOE facts, diagnostics, jobs, validator reports, and UI boundary failures

...
| Complex overclaiming | imaginary parts discarded or trajectory presented as domain coloring | only real-parameterized Argand trajectory; Both is synchronized split; explicit stops | unit-circle and unsupported complex tests |
